    ...
    <>
      <div ref={heroRef} className='relative overflow-hidden z-0'>
        ...
        <div className="main-container h-screen flex flex-col lg:justify-center items-start lg:py-12 max-lg:pt-40">
          <h1 className="text-3xl lg:text-[3.2vw] uppercase font-heading font-semibold">Divyanshu Singh</h1>
          <h2 className="text-6xl lg:text-[8vw] font-heading font-bold leading-[1] tracking-tight mt-3 mb-6">MERN Developer <br/> & <span className='text-stroke'> Designer </span></h2>
              <div className="flex gap-4 mt-4">
                <GradientButton text="Let's Talk" link="mailto:divyanshu19122008.v18@gmail.com" className="gradient-btn" />
                <button 
                  onClick={() => setShowPopup(true)}
                  className="btn btn-light uppercase font-heading border-2 border-transparent text-center min-w-[205px] px-12 py-2 lg:py-3 rounded-full max-sm:text-lg"
                >
                  About Me
                </button>
              </div>
      ...
      {/* Popup Modal */}
      <PopupModal isOpen={showPopup} onClose={() => setShowPopup(false)} image={popupicon} />
    </>
  )
}
