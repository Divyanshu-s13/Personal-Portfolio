      ...
      <div className='relative'>
        ...
        <div className="bg-[#E9E9F0] text-black pt-16 lg:pt-20 pb-[23rem] sticky top-1/3">
          <div className="main-container grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 items-start">
            ...
            <div className="flex items-center">
              <p className="text-lg lg:text-xl leading-relaxed">
                  I focus on creating efficient, responsive, and user-centric web applications. I love turning ideas into interactive digital products through modern technologies like React, Node.js, Express, and MongoDB.
              </p>
            </div>
